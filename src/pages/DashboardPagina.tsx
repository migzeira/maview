          ...
          <div className="p-5 relative z-10">
            ...
            <div className="flex flex-col items-center mb-5">
              ...
              {(() => {
                ...
                socialLinks.slice(0, 4).forEach(link => {
                  icons.push(
                    <div key={link.id} className="w-7 h-7 rounded-full flex items-center justify-center" style={{ background: `${pAccent}15`, border: `1px solid ${pAccent}18` }}>
                      <span style={{ color: pText }}>{LINK_ICON_MAP[link.icon] || <Globe size={10} />}</span>
                    </div>
                  );
                });
                // WhatsApp icon
                if (config.whatsapp) {
                  icons.push(
                    <div key="wa" className="w-7 h-7 rounded-full flex items-center justify-center" style={{ background: "rgba(37,211,102,0.15)", border: "1px solid rgba(37,211,102,0.25)" }}>
