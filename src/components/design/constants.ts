...
export const REFERENCE_PROFILES: ReferenceProfile[] = [
  ...
  /* 5 — Finanças (Mateus) */ { name: "Mateus Cavalcanti", username: "@mateus.financas",
    bio: "CFP® · Ex-XP Investimentos · Planejamento patrimonial para empresários", verified: true,
    avatar: U("photo-1472099645785-5658abf4ff4e", 400, 500, "face"),
    socials: ["yt", "li", "ig"],
    links: [
      { title: "Diagnóstico financeiro em 7 min", image: U("photo-1611974789855-9c2a0a7236a3", 80, 80, "center") },
      { title: "Carta semanal · 18k leitores", image: U("photo-1554224155-6726b3ff858f", 80, 80, "center") },
    ],
    products: [
      { title: "Mentoria Patrimonial 1:1 · 12 sessões", price: "R$ 4.997", cta: "Aplicar agora",
        image: U("photo-1563013544-824ae1b704d3", 600, 400, "center") },
      { title: "Planilha de controle patrimonial", price: "R$ 67", originalPrice: "R$ 197", discount: "66% OFF",
        cta: "Baixar",
  ...
  /* 7 — Beleza (Beatriz) — CENTRAL */ { name: "Beatriz Lins", username: "@beatrizlins.glow",
    ...
    links: [
      { title: "Análise de pele em 60s · IA", image: U("photo-1570172619644-dfd03ed5d881", 80, 80, "center") },
      { title: "Lista de espera Black Friday", image: U("photo-1556228720-195a672e8a03", 80, 80, "center") },
    ],
    products: [
      { title: "Método Glow12 · programa 12 semanas", price: "R$ 397", originalPrice: "R$ 597", discount: "33% OFF",
        cta: "Inscrever-se",
  ...
  /* 8 — Branding (Isabela) */ { name: "Isabela Rios", username: "@isabelarios.brand",
    ...
    links: [
      { title: "Brand Audit framework · PDF", image: U("photo-1561070791-2526d30994b5", 80, 80, "center") },
      { title: "Studio cases · Behance", image: U("photo-1586282391129-76a6df230234", 80, 80, "center") },
    ],
    products: [
      { title: "Brand Sprint · 5 dias com a Isabela", price: "R$ 12.500", cta: "Aplicar",
  ...
  /* 9 — Growth (Vitor) */ { name: "Vitor Meireles", username: "@vitor.growth",
    ...
    socials: ["yt", "ig", "tt", "li"],
    links: [
      { title: "Auditoria de funil em 24h · grátis", image: U("photo-1460925895917-afdab827c52f", 80, 80, "center") },
      { title: "Estudos de caso · 7 figuras", image: U("photo-1551288049-bebda4e38f71", 80, 80, "center") },
    ],
    products: [
      { title: "Growth OS · sistema completo de aquisição", price: "R$ 4.997", originalPrice: "R$ 7.997",
        cta: "Quero o sistema",
  ...
  /* 10 — Moda (Julia) */ { name: "Julia Martins", username: "@julia.moda_premium",
    ...
    socials: ["ig", "pin", "tt", "li"],
    links: [
      { title: "Quiz de estilo · resultado em 3min", image: U("photo-1490481651871-ab68de25d43d", 80, 80, "center") },
      { title: "Lookbook outono/inverno · PDF", image: U("photo-1529626455594-4ff0802cfb7e", 80, 80, "center") },
    ],
    products: [
      { title: "Consultoria Completa · guarda-roupa + coloração", price: "R$ 1.890", cta: "Reservar horário",
        image: U("photo-1522335789203-aabd1fc54bc9", 600, 400, "center") },
      { title: "Curso Estilo Pessoal · 6 módulos", price: "R$ 597", originalPrice: "R$ 997",
        cta: "Garantir vaga",
  ...
  /* 11 — Fotografia (Lucas) */ { name: "Lucas Pereira", username: "@lucas.perfil_critico",
    ...
    socials: ["ig", "pin", "tt", "li"],
    links: [
      { title: "Portfolio · 2024 best of", image: U("photo-1542038784456-1ea8e935640e", 80, 80, "center") },
      { title: "Pack 80 presets Lightroom · grátis", image: U("photo-1452587925148-ce544e77e70d", 80, 80, "center") },
    ],
    products: [
  ...
  /* 12 — Wellness (Clínica Serenity) */ { name: "Clínica Serenity", username: "@clinica.serenity_estetica",
    ...
    links: [
      { title: "Tour virtual da clínica · 360°", image: U("photo-1540555700478-4be289fbecef", 80, 80, "center") },
      { title: "Avaliação gratuita por WhatsApp", image: U("photo-1559757175-5700dde675bc", 80, 80, "center") },
    ],
    products: [
      { title: "Day Detox · 6h de tratamento integrativo", price: "R$ 1.490", cta: "Reservar",
